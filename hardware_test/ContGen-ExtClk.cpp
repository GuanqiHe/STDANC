...
int main(void)
{
	...
	for(;i<1000;i++)
		data[i] = 2.0*sin((double)i*100.0*PI/1000.0);

	/*********************************************/
	// DAQmx Configure Code
	/*********************************************/
	DAQmxErrChk (DAQmxCreateTask("",&taskHandle));
	DAQmxErrChk (DAQmxCreateAOVoltageChan(taskHandle,"Mod1/ao0","makeSomeNoise",-4.0,4.0,DAQmx_Val_Volts,NULL));
	DAQmxErrChk (DAQmxCfgSampClkTiming(taskHandle,"OnboardClock",1000.0,DAQmx_Val_Rising,DAQmx_Val_ContSamps,1000));
